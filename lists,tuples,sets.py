...
courses.insert(0,courses_2) # inserts whole lists as an item in the list same for append 
...
sort_course_2 = sorted(courses_2) # function to return sorted list , without altering the original list
